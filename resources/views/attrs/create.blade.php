...
<div class="row justify-content-center" style="margin:0px;margin-bottom: 100px;background-color:#f7f8fa;">
	<div class="col-12 col-lg-10 col-xl-10">
		...
		<div class="mt-4"></div>
		<form id="formCreateAttrs" method="">
			<!-- basic-info -->
			<div class="card">
				...
				<div class="card-body">
						...
						<div class="form-group">
							...
							<div class="col-md-6 btn-group-toggle d-flex" data-toggle="buttons">
								<label class="btn btn-white col mr-2">
									<input type="radio" name="fill_type" value="1">选项框
								</label>
								<label class="btn btn-white col ml-2">
									<input type="radio" name="fill_type" value="2" checked>文本框
								</label>
								<label class="btn btn-white col ml-2">
									<input type="radio" name="fill_type" value="3">选择框
								</label>
								<label class="btn btn-white col ml-2">
									<input type="radio" name="fill_type" value="4">单选框
								</label>
							</div>
						</div>
					</div>
					<div class="col-10">
						<div class="form-group">
							...
							<div class="col-md-4 btn-group-toggle d-flex" data-toggle="buttons">
								<label class="btn btn-white col mr-2">
									<input type="radio" name="is_numeric" value="1">是
								</label>
								<label class="btn btn-white col ml-2">
									<input type="radio" name="is_numeric" value="2" checked>否
								</label>
							</div>
						</div>
					</div>
					<div class="col-10">
						<div class="form-group">
							...
							<div class="col-md-4 btn-group-toggle d-flex" data-toggle="buttons">
								<label class="btn btn-white col mr-2">
									<input type="radio" name="is_searching" value="1">需要搜索
								</label>
								<label class="btn btn-white col ml-2">
									<input type="radio" name="is_searching" value="2" checked>不需要搜索
								</label>
							</div>
						</div>
					</div>
					<div class="col-5">
						<div class="form-group">
							...
							<div class="input-group ml-3 mb-3">
								<input type="text" maxlength="5" name="unit" class="form-control form-control-appended" placeholder="最多允许输入3个汉字（6字符）">
								<div class="input-group-append">
									<div class="input-group-text sf-text-13">
					...
					<div class="col-10">
						<div class="form-group">
							...
							<div class="col-md-4 btn-group-toggle d-flex" data-toggle="buttons">
								...
								<label class="btn btn-white col ml-2">
									<input type="radio" name="is_required" value="2" checked>否
								</label>
							</div>
						</div>
					</div>
